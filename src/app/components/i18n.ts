...
const translations: Record<string, TranslationEntry> = {
  ...
  "ppf.intro": { en: "Please complete this form within 24 hours of admission so your preferences are included in your care plan. Every question is optional.", ar: "يرجى إكمال هذا النموذج خلال ٢٤ ساعة من الدخول ليتم تضمين تفضيلاتك في خطة رعايتك. جميع الأسئلة اختيارية.", ur: "براہ کرم یہ فارم داخلے کے 24 گھنٹوں کے اندر مکمل کریں تاکہ آپ کی ترجیحات آپ کے نگہداشت پلان میں شامل کی جا سکیں۔ تمام سوالات اختیاری ہیں۔" },
  ...
  /* Sections */
  "ppf.section.food.title": { en: "Food & Catering", ar: "الطعام والتغذية", ur: "کھانا اور کیٹرنگ" },
  "ppf.section.food.subtitle": { en: "Meal timings and dietary needs", ar: "أوقات الوجبات والاحتياجات الغذائية", ur: "کھانے کے اوقات اور غذائی ضروریات" },
  "ppf.section.partner.title": { en: "Care Partner Program", ar: "برنامج شريك الرعاية", ur: "کیئر پارٹنر پروگرام" },
  "ppf.section.partner.subtitle": { en: "A family member or friend involved in your care", ar: "أحد أفراد الأسرة أو صديق يشارك في رعايتك", ur: "خاندان کا فرد یا دوست جو آپ کی دیکھ بھال میں شریک ہو" },
  "ppf.section.handover.title": { en: "Bedside Handover", ar: "التسليم بجانب السرير", ur: "بیڈ سائیڈ ہینڈ اوور" },
  "ppf.section.handover.subtitle": { en: "Doctor rounds and shift handover times", ar: "أوقات جولات الأطباء وتسليم المناوبة", ur: "ڈاکٹروں کے راؤنڈ اور شفٹ ہینڈ اوور کے اوقات" },
  "ppf.section.religious.title": { en: "Religious, Emotional & Interpreter Care", ar: "الرعاية الدينية والعاطفية وخدمات الترجمة", ur: "مذہبی، جذباتی اور ترجمان خدمات" },
  "ppf.section.religious.subtitle": { en: "Spiritual support and language services", ar: "الدعم الروحي وخدمات اللغة", ur: "روحانی معاونت اور زبان کی خدمات" },
  "ppf.section.comfort.title": { en: "Comfort & Safety", ar: "الراحة والسلامة", ur: "آرام اور حفاظت" },
  "ppf.section.comfort.subtitle": { en: "Grooming, bathing and your rights", ar: "العناية الشخصية والاستحمام وحقوقك", ur: "بناؤ سنگھار، غسل اور آپ کے حقوق" },
  "ppf.section.other.title": { en: "Other Preferences", ar: "تفضيلات أخرى", ur: "دیگر ترجیحات" },
  "ppf.section.other.subtitle": { en: "Anything else we should know", ar: "أي شيء آخر ينبغي أن نعرفه", ur: "کوئی اور بات جو ہمیں معلوم ہونی چاہیے" },

  /* Questions */
  "ppf.q.food.mealTiming": { en: "Breakfast, lunch and dinner are served at set times. Do you have any preference for these meal timings?", ar: "يتم تقديم الإفطار والغداء والعشاء في أوقات محددة. هل لديك أي تفضيل بشأن مواعيد هذه الوجبات؟", ur: "ناشتہ، دوپہر اور رات کا کھانا مقررہ اوقات پر دیا جاتا ہے۔ کیا ان اوقات کے بارے میں آپ کی کوئی ترجیح ہے؟" },
  "ppf.q.food.dietary": { en: "Do you have a dietary preference?", ar: "هل لديك تفضيل غذائي؟", ur: "کیا آپ کی کوئی غذائی ترجیح ہے؟" },
  "ppf.q.partner.participate": { en: "Would you like to take part in the Care Partner Program?", ar: "هل ترغب في المشاركة في برنامج شريك الرعاية؟", ur: "کیا آپ کیئر پارٹنر پروگرام میں حصہ لینا چاہیں گے؟" },
  "ppf.q.partner.appAccess": { en: "Would you or your care partner like to access your lab results and medical records through the hospital app?", ar: "هل ترغب أنت أو شريك الرعاية في الاطلاع على نتائج المختبر والسجلات الطبية عبر تطبيق المستشفى؟", ur: "کیا آپ یا آپ کا کیئر پارٹنر ہسپتال ایپ کے ذریعے آپ کی لیب رپورٹس اور طبی ریکارڈ دیکھنا چاہیں گے؟" },
  "ppf.q.handover.roundTime": { en: "Doctors usually round between 8:00 AM and 12:00 PM. If this does not suit you, what time do you prefer?", ar: "عادةً ما يقوم الأطباء بجولاتهم بين الساعة ٨:٠٠ صباحاً و١٢:٠٠ ظهراً. إذا لم يكن هذا مناسباً لك، ما الوقت الذي تفضله؟", ur: "ڈاکٹر عام طور پر صبح 8:00 سے دوپہر 12:00 کے درمیان راؤنڈ کرتے ہیں۔ اگر یہ آپ کے لیے مناسب نہیں تو آپ کون سا وقت پسند کریں گے؟" },
  "ppf.q.handover.presence": { en: "Would you like to be present at the bedside handover at 7:00 AM and 7:00 PM, or receive a summary later instead?", ar: "هل ترغب في الحضور أثناء التسليم بجانب السرير في الساعة ٧:٠٠ صباحاً و٧:٠٠ مساءً، أم تفضل استلام ملخص لاحقاً؟", ur: "کیا آپ صبح 7:00 اور شام 7:00 بجے بیڈ سائیڈ ہینڈ اوور کے وقت موجود رہنا چاہیں گے، یا بعد میں خلاصہ وصول کرنا پسند کریں گے؟" },
  ...
  "ppf.q.religious.support": { en: "Would you like to request spiritual or religious support?", ar: "هل ترغب في طلب الدعم الروحي أو الديني؟", ur: "کیا آپ روحانی یا مذہبی معاونت کی درخواست کرنا چاہیں گے؟" },
  "ppf.q.religious.interpreter": { en: "Do you need a translator or a sign language service?", ar: "هل تحتاج إلى مترجم أو خدمة لغة الإشارة؟", ur: "کیا آپ کو مترجم یا اشاروں کی زبان کی سروس درکار ہے؟" },
  "ppf.q.comfort.grooming": { en: "Do you need grooming services?", ar: "هل تحتاج إلى خدمات العناية الشخصية؟", ur: "کیا آپ کو بناؤ سنگھار کی خدمات درکار ہیں؟" },
  ...
  "ppf.q.comfort.rights": { en: "Do you know about your rights and responsibilities?", ar: "هل تعرف حقوقك ومسؤولياتك؟", ur: "کیا آپ اپنے حقوق اور ذمہ داریوں سے واقف ہیں؟" },
  "ppf.q.other.otherPreference": { en: "Is there any other preference not mentioned in this form that you would like to request?", ar: "هل هناك أي تفضيل آخر غير مذكور في هذا النموذج ترغب في طلبه؟", ur: "کیا کوئی اور ترجیح ہے جو اس فارم میں شامل نہیں اور آپ درخواست کرنا چاہیں گے؟" },
  "ppf.q.other.virtualRoom": { en: "The Virtual Room covers your rights and responsibilities, important contacts and quiet time. Do you confirm this has been explained to you?", ar: "تغطي الغرفة الافتراضية حقوقك ومسؤولياتك وجهات الاتصال المهمة ووقت الهدوء. هل تؤكد أنه تم شرح ذلك لك؟", ur: "ورچوئل روم میں آپ کے حقوق و ذمہ داریاں، اہم رابطے اور خاموشی کا وقت شامل ہیں۔ کیا آپ تصدیق کرتے ہیں کہ یہ آپ کو سمجھا دیا گیا ہے؟" },
  "ppf.q.other.favouriteColour": { en: "What is your favourite colour?", ar: "ما هو لونك المفضل؟", ur: "آپ کا پسندیدہ رنگ کون سا ہے؟" },
