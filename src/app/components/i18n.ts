...
const translations: Record<string, TranslationEntry> = {
  ...
  "onboarding.consent.prefs.before": { en: "I've completed the ", ar: "لقد أكملت ", ur: "میں نے " },
  "onboarding.consent.prefs.link": { en: "Patient Preference Form", ar: "نموذج تفضيلات المريض", ur: "مریض کی ترجیحات کا فارم" },
  "onboarding.consent.prefs.after": { en: "", ar: "", ur: " مکمل کر لیا ہے" },
  ...
  /* ─── Patient Preferences Form (V12) — opened from the consent step ───
     Answers are stored as language-neutral keys; only these labels change
     with the locale. Every question needs all three languages. */
