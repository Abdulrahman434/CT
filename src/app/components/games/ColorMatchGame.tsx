      ...
      >
        ...
        <div className="flex items-center gap-4">
          <div className="flex flex-col items-end">
            ...
            <span style={{ fontFamily, fontSize: TYPE_SCALE.sm, fontWeight: WEIGHT.bold, color: theme.primaryOn }}>{gt.combo}: {combo}x</span>
          </div>
          <div
        ...
        {!isPlaying && timeLeft === 30 ? (
          ...
          <div className="flex flex-col items-center gap-8">
            ...
            <div className="flex flex-col items-center gap-2">
              <p style={{ fontFamily, fontSize: TYPE_SCALE.xl, fontWeight: WEIGHT.semibold, color: theme.primaryOn }}>
                {gt.finalScore}: {score}
              </p>
